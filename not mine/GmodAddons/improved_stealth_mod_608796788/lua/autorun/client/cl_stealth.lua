...
hook.Add("HUDPaint","DrawSplinterCellThing",function()
	...
	if GetConVarNumber("stealth_drawbar")==1 then
		...
		surface.SetDrawColor(0,0,0,255)
		if GetConVarNumber("stealth_drawbar")==2 then draw.Circle( hudxpos+160, hudypos+50, 12, 50 )
		elseif GetConVarNumber("stealth_drawbar")==3 then draw.Circle( hudxpos+160, hudypos+35, 12, 50 )
		elseif GetConVarNumber("stealth_drawbar")==4 then draw.Circle( hudxpos+160, hudypos+80, 12, 50 ) end
	end
	...
	if GetConVarNumber("stealth_drawbar")==1 or GetConVarNumber("stealth_drawbar")==2 then draw.Circle( hudxpos+160, hudypos+50, 8, 50 )
	elseif GetConVarNumber("stealth_drawbar")==3 then draw.Circle( hudxpos+160, hudypos+35, 8, 50 )
	elseif GetConVarNumber("stealth_drawbar")==4 then draw.Circle( hudxpos+160, hudypos+80, 8, 50 ) end
...
local function NPCAlerted( data )
	...
	if IsValid( npc ) and !table.HasValue(hunters, npc) then
		...
		if GetConVar("stealth_enablesound"):GetInt() != 0 and silent == false and sounddelay < CurTime() then
			LocalPlayer():EmitSound( "stealth/alert.wav" , 100, 100, 0.4, CHAN_AUTO )
