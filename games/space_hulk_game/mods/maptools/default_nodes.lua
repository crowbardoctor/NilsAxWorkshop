...
minetest.register_node("maptools:stoneblock", {
	description = S("Unbreakable Stone Block"),
	range = 12,
	stack_max = 10000,
...
minetest.register_node("maptools:tinblock", {
	description = S("Unbreakable Tin Block"),
	range = 12,
	stack_max = 10000,
